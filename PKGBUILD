...
makedepends=('linux-bede>=4.3rc1' 'linux-bede<4.4' 'linux-bede-headers>=4.3rc1' 'linux-bede-headers<4.4' "nvidia-utils=$pkgver" "nvidia-libgl=$pkgver")
provides=('nvidia')
license=('custom')
...
sha256sums=('ee6e137b702a48e295d310da1713b6c7f61f854539bf919c17d39321aac5407a')
...
package() {
    depends=('linux-bede>=4.3rc1' 'linux-bede<4.4' "nvidia-utils=${pkgver}" "nvidia-libgl=$pkgver")
